...
[fig,ax] = plot_xy(MOM,{'ar_psd_VU'},{'ar_sfc_VU'},levels,'levels',ifdirs,1,...
    {'ver3/4','ver4/3','hor3/4','hor4/3'},'XLim',[0.3 1.5],'YLim',[0.3 1.5]);
...
[fig,ax] = plot_xy(MOM,{'ar_psd_WU'},{'ar_sfc_WU'},levels,'levels',ifdirs,1,...
    {'ver3/4','ver4/3','hor3/4','hor4/3'},'XLim',[0.2 2],'YLim',[0.2 2]);
legend(cat(2,levels),'Location','best')
...
fig = plot_xy(MOM,{'slp_sfc_W','slp_sfc_UX','slp_sfc_VY'},...
    {'slp_psd_W','slp_psd_UX','slp_psd_VY'},levels,'vars',ifdirs,0,{'ver2/3','hor5/3'},...
